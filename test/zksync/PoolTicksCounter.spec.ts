...
// this test can't be executed because deployMockContract from ethereum-waffle set to address = NULL,
// which not allow in zkevm. Error message: Failed to serialize transaction: toAddressIsNull
describe('PoolTicksCounter', () => {
  ...
  TICK_SPACINGS.forEach((TICK_SPACING) => {
    ...
    before(async () => {
      ...
      PoolTicksCounter = (await getContractInstance("PoolTicksCounterTest")) as PoolTicksCounterTest
