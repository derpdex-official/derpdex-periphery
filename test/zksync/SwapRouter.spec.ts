...
import { IUniswapV3Factory, IWETH9, MockTimeNonfungiblePositionManager, MockTimeSwapRouter, TestERC20 } from '../../typechain'
...
describe('SwapRouter', function () {
  ...
  describe('swaps', () => {
    ...
    async function createPoolWETH9(tokenAddress: string) {
      let tx
      tx = await weth9.deposit({ value: liquidity })
      await tx.wait()
      tx = await weth9.approve(nft.address, constants.MaxUint256)
      await tx.wait()
    ...
    beforeEach('create 0-1 and 1-2 pools', async () => {
      let tx
      tx = await createPool(tokens[0].address, tokens[1].address)
      await tx.wait()
      tx = await createPool(tokens[1].address, tokens[2].address)
      await tx.wait()
    })
    ...
    describe('#exactInput', () => {
      ...
      describe('single-pool', () => {
        it('0 -> 1', async () => {
          ...
          const tx = await exactInput(tokens.slice(0, 2).map((token) => token.address))
          await tx.wait()
      ...
      describe('multi-pool', () => {
        ...
        it('2 -> 1 -> 0', async () => {
          ...
          const tx = await exactInput(tokens.map((token) => token.address).reverse(), 5, 1)
          await tx.wait()
      ...
      describe('ETH input', () => {
        describe('WETH9', () => {
          beforeEach(async () => {
            const tx = await createPoolWETH9(tokens[0].address)
            await tx.wait()
          })
      ...
      describe('ETH output', () => {
        describe('WETH9', () => {
          beforeEach(async () => {
            ...
            await tx.wait()
            tx = await createPoolWETH9(tokens[1].address)
            await tx.wait()
          })
    ...
    describe('#exactInputSingle', () => {
      ...
      it('0 -> 1', async () => {
        ...
        const tx = await exactInputSingle(tokens[0].address, tokens[1].address)
        await tx.wait()
      ...
      it('1 -> 0', async () => {
        ...
        const tx = await exactInputSingle(tokens[1].address, tokens[0].address)
        await tx.wait()
    ...
    describe('#exactOutput', () => {
      ...
      describe('single-pool', () => {
        it('0 -> 1', async () => {
          ...
          const tx = await exactOutput(tokens.slice(0, 2).map((token) => token.address))
          await tx.wait()
      ...
      describe('multi-pool', () => {
        ...
        it('2 -> 1 -> 0', async () => {
          ...
          const tx = await exactOutput(tokens.map((token) => token.address).reverse(), 1, 5)
          await tx.wait()
    ...
    describe('#exactOutputSingle', () => {
      ...
      it('0 -> 1', async () => {
        ...
        const tx = await exactOutputSingle(tokens[0].address, tokens[1].address)
        await tx.wait()
      ...
      it('1 -> 0', async () => {
        ...
        const tx = await exactOutputSingle(tokens[1].address, tokens[0].address)
        await tx.wait()
    ...
    describe('*WithFee', () => {
      ...
      it('#sweepTokenWithFee', async () => {
        ...
        const tx = await router.connect(trader).multicall(data)
        await tx.wait()
      ...
      it('#unwrapWETH9WithFee', async () => {
        ...
        tx = await router.connect(trader).multicall(data)
        await tx.wait()
        // const endBalance = await waffle.provider.getBalance(feeRecipient)
        const endBalance = await provider.getBalance(feeRecipient)
